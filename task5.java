...
public class task5 {
        ...
        public void admin_login()
        {
            ...
            loginto.put("Ratna",13579);
            loginto.put("Jiva",88997);
        ...
        public void user_login()
        {
            ...
            System.out.print("Enter Password: ");
            int password = sc.nextInt();
            loginto.put("Sakshi",77665);
            loginto.put("Riya",98765);
            loginto.put("Soumy",12345);
            loginto.put("Salim",24680);
        ...
        {
            System.out.println("--------------------------------------------------------");
            System.out.println("----- Digital Library ---> Welcome Admin " + task4.userID + "! ----");
        ...
        {
            System.out.println("--------------------------------------------------------");
            System.out.println("----- Digital Library ---> Welcome User " + task4.userID + "! -----");
        ...
        public void returns()
        {
            ...
            if(book_database_server().containsKey(issues))
            {
                ...
                System.out.println("\n" + "You don't have any issued book2.!!!");
            }
            user_mainpage();
        }
